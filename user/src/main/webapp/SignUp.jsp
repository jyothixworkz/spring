...
<body>
	...
	<br></br>
	<h5 style="text-align: center;">${UserDTO.name}</h5>
	<div class="main">
		<h4>SignUp</h4> 
		<form action="user" method="post" enctype="multipart/form-data">

			<label>Name</label> <input type="text" name="name" placeholder="Name">
			<label>Email</label> <input type="email" name="mailId" placeholder="Email">
			 <label>Mobile Number</label> <input type="text" name="phoneNumber" placeholder="Mobile Number"><br>
